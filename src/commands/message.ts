...
export interface MessageCommandFields {
  name: string;
 ...
 * @category Commands
 */
export class MessageCommand implements MessageCommandFields {
  name: string;
  ...
  constructor(
    command: Omit<MessageCommandFields, "nameLocalizations" | "descriptionLocalizations">
  ) {
